...
INSERT INTO `item` VALUES (1994378562022295069, 1994378398924345350, '润唇膏', '保湿润唇膏，防止干裂。', 'https://img2.baidu.com/it/u=1711593108,3593891607&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=660', 19, 13, 35, '支', 0, 0, '2025-11-28 20:15:46', '2025-12-07 17:50:58');
INSERT INTO `item` VALUES (1994378563022295042, 1994378398924345345, '灰色布娃娃', '非常大的毛绒灰色布娃娃，适合儿童玩耍。', 'https://t15.baidu.com/it/u=2009098259,978597714&fm=224&app=112&f=JPEG?w=500&h=500', 199, 1, 10, '个', 0, 0, '2025-11-28 20:11:17', '2025-12-11 23:49:30');
...
INSERT INTO `item` VALUES (1994378563022295065, 1994378398924345349, '运动水杯', '大容量不锈钢运动水杯，保温保冷，适合户外活动。', 'https://img0.baidu.com/it/u=4276707929,2178149955&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=1422', 129, 2, 17, '个', 0, 0, '2025-11-28 20:34:17', '2025-12-07 17:46:16');
...
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '登录日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1099 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1999145309042229251 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '购买记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of purchase_record
-- ----------------------------
INSERT INTO `purchase_record` VALUES (1999145261042614274, 1994378563022295080, 1994411050276564994, '移动电源', 1, NULL, NULL, NULL, 0, '2025-12-11 23:52:27', '2025-12-11 23:52:27', '20251211684669');
INSERT INTO `purchase_record` VALUES (1999145283603775490, 1994378563022295083, 1994411050276564994, '电脑包', 1, NULL, NULL, NULL, 0, '2025-12-11 23:52:32', '2025-12-11 23:52:32', '20251211498682');
INSERT INTO `purchase_record` VALUES (1999145309042229250, 1994378563022295082, 1994411050276564994, '笔记本电脑支架', 1, '1', 12.90, '2025-12-11 23:52:51', 0, '2025-12-11 23:52:38', '2025-12-11 23:52:38', '20251211416059');
...
INSERT INTO `sign_in_record` VALUES (1999008482872324098, 1994411050276564994, '2025-12-11 14:48:57', 2, 15, '2025-12-11 14:48:56', '2025-12-11 14:48:56', 0);
...
CREATE TABLE `transaction_record`  (
  ...
  `type` tinyint(4) NOT NULL COMMENT '变动类型 (1: 签到奖励, 2: 兑换商品, 3: 补签扣除等)',
  `payType` tinyint(4) NOT NULL COMMENT '支付方式（1：积分支付，2：支付宝支付）',
...
-- ----------------------------
INSERT INTO `transaction_record` VALUES (1999089580419649538, 1994411050276564994, 179, 2, 0, NULL, 1999089580222517250, '兑换了 1 个编号是 1994378563022295074 的商品，共用了 179积分。', '2025-12-11 20:11:11', '2025-12-11 20:11:11', 0);
INSERT INTO `transaction_record` VALUES (1999089595397509123, 1994411050276564994, 179, 2, 0, NULL, 1999089595397509122, '兑换了 1 个编号是 1994378563022295074 的商品，共用了 179积分。', '2025-12-11 20:11:15', '2025-12-11 20:11:15', 0);
INSERT INTO `transaction_record` VALUES (1999094598308823043, 1994411050276564994, 129, 2, 1, 0.00, 1999094598308823042, '兑换了 1 个编号是 1994378563022295082 的商品，共用了 129积分。', '2025-12-11 20:31:08', '2025-12-11 20:31:08', 0);
INSERT INTO `transaction_record` VALUES (1999094796128976897, 1994411050276564994, 0, 2, 2, 129.00, 1999094689677541378, '1994411050276564994购买成功，消费了 129.00元。', '2025-12-11 20:31:55', '2025-12-11 20:31:55', 0);
INSERT INTO `transaction_record` VALUES (1999133393771036674, 1994411050276564994, 19, 2, 1, 0.00, 1999133393750065154, '兑换了 1 个编号是 1994378562022295069 的商品，共用了 19积分。', '2025-12-11 23:05:17', '2025-12-11 23:05:17', 0);
INSERT INTO `transaction_record` VALUES (1999133476352688130, 1994411050276564994, 0, 2, 2, 19.00, 1999133405192126465, '购买1999133405192126465商品成功，消费了 19.00元。', '2025-12-11 23:05:37', '2025-12-11 23:05:37', 0);
INSERT INTO `transaction_record` VALUES (1999139149941579777, 1994411050276564994, 0, 2, 2, 179.00, 1999139110854860802, '购买1999139110854860802商品成功，消费了 179.00元。', '2025-12-11 23:28:10', '2025-12-11 23:28:10', 0);
INSERT INTO `transaction_record` VALUES (1999140184449916930, 1994411050276564994, 0, 2, 2, 2.50, 1999140129861050369, '购买1999140129861050369商品成功，消费了 2.50元。', '2025-12-11 23:32:16', '2025-12-11 23:32:16', 0);
INSERT INTO `transaction_record` VALUES (1999145261059391490, 1994411050276564994, 169, 2, 1, 0.00, 1999145261042614274, '兑换了 1 个编号是 1994378563022295080 的商品，共用了 169积分。', '2025-12-11 23:52:27', '2025-12-11 23:52:27', 0);
INSERT INTO `transaction_record` VALUES (1999145283603775491, 1994411050276564994, 179, 2, 1, 0.00, 1999145283603775490, '兑换了 1 个编号是 1994378563022295083 的商品，共用了 179积分。', '2025-12-11 23:52:32', '2025-12-11 23:52:32', 0);
INSERT INTO `transaction_record` VALUES (1999145361190010882, 1994411050276564994, 0, 2, 2, 12.90, 1999145309042229250, '购买1999145309042229250商品成功，消费了 12.90元。', '2025-12-11 23:52:51', '2025-12-11 23:52:51', 0);
...
INSERT INTO `user` VALUES (1994411050276564994, 'zhangsan', 'c5704561f824fd4698c4f9cb23f08dc2', 'zhangsan', '21312@qq.com', 0, '12345678', 146, 2, 'http://10.126.126.1:8009/leirui-oss/scholl point mall/upload/6929b2d1d1ad3ec30f929ba0.jpeg', '普通用户一枚', 0, 0, '2025-11-28 22:20:23', '2025-12-11 20:10:23', 0);
...
-- ----------------------------
INSERT INTO `user_activity` VALUES (1, 1992487379278557186, 122, '2025-12-11 23:53:08', '2025-12-11 23:53:08', 1220, '2025-11-23 14:56:24', '2025-12-11 23:53:08');
INSERT INTO `user_activity` VALUES (2, 1994411050276564994, 218, '2025-12-11 23:52:22', '2025-12-11 23:52:22', 2180, '2025-11-28 22:20:23', '2025-12-11 23:52:21');
