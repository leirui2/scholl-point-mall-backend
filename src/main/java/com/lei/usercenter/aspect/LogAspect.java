package com.lei.usercenter.aspect;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.alibaba.fastjson.serializer.SimplePropertyPreFilter;
import com.lei.usercenter.common.ApiResponse;
import com.lei.usercenter.mapper.OperationLogMapper;
...
public class LogAspect {
     ...
     * @throws Throwable 异常
     */
    @Around("execution(* com.lei.usercenter.controller..*.*(..)) && (@annotation(org.springframework.web.bind.annotation.RequestMapping) || @annotation(org.springframework.web.bind.annotation.PostMapping) || @annotation(org.springframework.web.bind.annotation.GetMapping))")
